---
title: "Detectando y corrigiendo sesgo algorítmico: Fairlearn aplicado a casos reales de discriminación"
description: "Análisis completo de sesgo en modelos de machine learning usando Fairlearn. Casos de estudio: Boston Housing (sesgo racial) y Titanic (sesgo de género/clase)."
---
...
### 2. Análisis Exploratorio del Sesgo
...
![Análisis de Sesgo por Grupo Racial](/images/practica7/boxplot.png)
...
## Parte II: Titanic - Detectar y Corregir Sesgo de Género/Clase
...
#### Boston Housing
1. **Sesgo racial sistemático**: Áreas con mayor proporción afroamericana tienen valuaciones significativamente menores
...
3. **Corrección parcial**: Fairlearn reduce pero no elimina completamente el sesgo
